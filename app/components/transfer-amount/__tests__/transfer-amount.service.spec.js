describe('ledgerService service', function() {
    ...
    it('should give remaining balance as total balance on first call', function() {
        expect(LedgerService.getBalance()).toEqual(500);
    });
    ...
    it('should give false for amount greater than totalBalance', function() {
        expect(LedgerService.isValidAmount(600)).toBeFalsy();
    });
